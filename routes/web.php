...
Route::group(['middleware' => 'CheckLoginDoctor'], function(){
	...
	Route::get('view_update_doctor/{doctor_id}','doctor_controller@view_update_doctor')->name('view_update_doctor');
	Route::post('process_update_doctor/{doctor_id}','doctor_controller@process_update_doctor')->name('process_update_doctor');
	...
	Route::get('demo','doctor_controller@demo')->name('demo');
