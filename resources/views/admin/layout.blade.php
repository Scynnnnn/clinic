...
<div class="wrapper">
        ...
        <div class="user">
            <div class="info">
                <div class="logo">
                    <div class="photo">
                        {{-- <img height="50px" src="../assets/{{Session::get('profile_image')}}"> --}}
                        <img  src="{{ asset('storage/'.Session::get('profile_image')) }}">
                    </div>
        ...
        <div class="sidebar-wrapper"  >
            <ul class="nav">
                <li class="active">
                    <a href="{{route('your_informations',['patient_id'=>Session::get('admin_id')])}}">
