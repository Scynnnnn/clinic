...
<div class="wrapper">
        ...
        <div class="sidebar-wrapper"  >
            <ul class="nav">
                ...
                <li class="active">
                    <a href="<?php echo e(route('view_update_doctor',['doctor_id'=>Session::get('doctor_id')])); ?>">
                        <i class="pe-7s-add-user"></i>
                ...
                <li class="active">
                    <a href="<?php echo e(route('patient_record_mgt')); ?>">
                ...
                <li class="active">
                    <a href="<?php echo e(route('view_todo_list')); ?>">
                        <i class="pe-7s-note2"></i>
                        <p>Todo list</p>
                    </a>
                </li>
