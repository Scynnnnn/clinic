		...
		<fieldset>
			<div class="form-group">
				...
				<div class="col-sm-6">
					...
					<option value="0">--choose major--</option>
					<?php $__currentLoopData = $patient_name; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $each): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<option value ="<?php echo e($each->patient_id); ?>" >
