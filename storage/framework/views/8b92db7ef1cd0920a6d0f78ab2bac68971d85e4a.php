...
<div class="logo">
        ...
        <div class="sidebar-wrapper"  >
            <ul class="nav">
                 <li class="active">
                    <a href="<?php echo e(route('session_index')); ?>" style="padding-right: 155px;">
                ...
                <li class="active">
                    <a href="<?php echo e(route('set_appointment')); ?>" style="padding-right: 90px;">
                        <i class="pe-7s-id"></i>
                ...
                <li class="active">
                    <a href="<?php echo e(route('all_doctor')); ?>" style="padding-right: 165px;">
                        <i class="pe-7s-culture"></i>
                        <p>Doctors</p>
                    </a>
                </li>
                 <li class="active">
                    <a href="<?php echo e(route('view_all_appointment')); ?>" style="padding-right: 103px;">
